-- This script was copied from: https://raw.githubusercontent.com/lorint/AdventureWorks-for-Postgres/master/install.sql
-- (AdventureWorks for Postgres by Lorin Thwaits)
-- Then I removed all CSV (data) because we only need the db structure


-- How to use this script (how to setup this sample database):

-- Create the database and tables, import the data, and set up the views and keys with:
--   psql -c "CREATE DATABASE \"Adventureworks\";"
--          e.g. "C:\Program Files\PostgreSQL\13\bin\psql.exe" -h localhost -U postgres -c "CREATE DATABASE \"Adventureworks\";"
--   psql -d Adventureworks < install.sql
--          e.g. "C:\Program Files\PostgreSQL\13\bin\psql.exe" -h localhost -U postgres -d Adventureworks < install.sql
