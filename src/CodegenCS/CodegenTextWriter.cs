...
namespace CodegenCS
{
    ...
    public class CodegenTextWriter : TextWriter
    {
        ...
        /// <summary>
        /// If true, will remove the left padding of multi-line text blocks, by "untabbing" the block until some row "touches" the margin.
        /// </summary>
        protected bool _trimBlockPaddings = true;

        /// <summary>
        /// If true, will remove the first empty line of multi-line text blocks
        /// </summary>
        protected bool _trimFirstEmptyLine = true;
        ...
        public void Write(FormattableString formattable)
        {
            ...
            if (_trimFirstEmptyLine)
                format = TrimFirstEmptyLine(format);
        ...
        public override void Write(string value)
        {
            ...
            {
                if (_trimBlockPaddings)
                    value = TrimLeftPadding(value);
                if (_trimFirstEmptyLine)
                    value = TrimFirstEmptyLine(value);
        ...
        /// <returns></returns>
        protected string TrimLeftPadding(string block)
        {
        ...
        protected string TrimFirstEmptyLine(string block)
        {
            Match m = _lineBreaksRegex.Match(block);
            if (m != null && m.Success && m.Index == 0)
                return block.Substring(m.Length);
            return block;
        }
        #endregion
